    ...
    <div className="space-y-6">
      <div className="relative w-full aspect-[2/1] bg-white rounded-xl border border-border-light p-4 md:p-8 flex items-center justify-center overflow-hidden">
        <svg viewBox="0 0 800 300" className="w-full h-full text-slate-300" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <path d="M350 110 L350 190" strokeWidth="1" opacity="0.5" />
          <path d="M400 110 L400 190" strokeWidth="1" opacity="0.5" />
          <path d="M450 110 L450 190" strokeWidth="1" opacity="0.5" />
          <path d="M500 110 L500 190" strokeWidth="1" opacity="0.5" />
          <path d="M550 110 L550 190" strokeWidth="1" opacity="0.5" />
          <path d="M600 110 L600 190" strokeWidth="1" opacity="0.5" />
          <path d="M650 110 L650 190" strokeWidth="1" opacity="0.5" />
        ...
        <div className="hidden lg:block absolute top-[5%] right-[25%]">
          <InputOverlay label="Kesme Boyu" value={values.fluteLength} onChange={(v) => onChange("fluteLength", v)} />
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:hidden">
        ...
        <MobileInput label="Kesme Boyu" value={values.fluteLength} onChange={(v) => onChange("fluteLength", v)} unit="mm" />
