  ...
  return (
    <div className="relative w-full aspect-[2/1] bg-white rounded-xl border border-border-light p-8 flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        {/* Shank (Arka Kısım) */}
        <path
          d="M50 120 L300 120 L300 180 L50 180 Z"
          strokeWidth="2"
        ...
        {/* Transition */}
        <path
          d="M300 120 L330 110 L330 190 L300 180"
          strokeWidth="2"
          className="text-slate-400"
        />

        {/* Flute (Helis/Uç Kısım) */}
        <path
          d="M330 110 L700 110 L750 150 L700 190 L330 190 Z"
          strokeWidth="2"
      ...
      <div className="absolute top-[50%] right-[2%] -translate-y-[50%] flex flex-col items-center">
        <label className="text-[10px] font-bold text-slate-500 uppercase mb-1 bg-white/80 px-1">
          Ön Çap
        </label>
        <input
          type="number"
