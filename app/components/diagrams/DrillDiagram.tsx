...
export default function DrillDiagram({ values, onChange }: DrillDiagramProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="relative w-full aspect-[2/1] bg-white rounded-xl border border-border-light p-4 md:p-8 flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <path d="M330 110 L700 110 L750 150 L700 190 L330 190 Z" strokeWidth="2" className="text-slate-500" />
          <path d="M350 110 L400 190" strokeWidth="1" opacity="0.5" />
          <path d="M420 110 L470 190" strokeWidth="1" opacity="0.5" />
          <path d="M490 110 L540 190" strokeWidth="1" opacity="0.5" />
          <path d="M560 110 L610 190" strokeWidth="1" opacity="0.5" />
          <path d="M630 110 L680 190" strokeWidth="1" opacity="0.5" />
          <line x1="750" y1="150" x2="780" y2="150" strokeDasharray="4" />
          <path d="M780 110 L780 190" strokeDasharray="4" />
          <path d="M775 110 L785 110" />
          <path d="M775 190 L785 190" />
          <line x1="330" y1="110" x2="330" y2="80" strokeDasharray="4" />
          <line x1="750" y1="150" x2="750" y2="80" strokeDasharray="4" />
          <path d="M330 80 L750 80" strokeWidth="1" />
          <path d="M330 75 L330 85" />
          <path d="M750 75 L750 85" />
          <line x1="50" y1="180" x2="50" y2="240" strokeDasharray="4" />
          <line x1="750" y1="150" x2="750" y2="240" strokeDasharray="4" />
        ...
        <div className="hidden lg:block absolute top-[5%] right-[25%]">
          <InputOverlay label="Helis Boyu" value={values.fluteLength} onChange={(v) => onChange("fluteLength", v)} />
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:hidden">
        ...
        <MobileInput label="Helis Boyu" value={values.fluteLength} onChange={(v) => onChange("fluteLength", v)} unit="mm" />
    ...
    <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
      ...
      <div className="relative">
        <input
          ...
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm font-bold outline-none focus:border-primary transition-all"
        />
